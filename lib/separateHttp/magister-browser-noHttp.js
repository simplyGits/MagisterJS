...
(function() {
  ...
  this.Class = (function() {
    ...
    Class._convertRaw = function(magisterObj, raw) {
      ...
      obj._id = (_ref = raw.id) != null ? _ref : raw.Id;
      obj._beginDate = new Date(Date.parse(raw.begindatum));
      obj._endDate = new Date(Date.parse(raw.einddatum));
      obj._abbreviation = (_ref1 = raw.afkorting) != null ? _ref1 : raw.Afkorting;
      obj._description = (_ref2 = raw.omschrijving) != null ? _ref2 : raw.Omschrijving;
      obj._number = (_ref3 = raw.volgnr) != null ? _ref3 : raw.Volgnr;
      obj._teacher = Person._convertRaw(magisterObj, {
  ...
  this.Course = (function() {
    ...
    Course.prototype.grades = function() {
      var callback, fillGrade, fillPersons, onlyRecent, _ref;
      _ref = _.filter(arguments, function(a) {
        return _.isBoolean(a);
      }), fillPersons = _ref[0], fillGrade = _ref[1], onlyRecent = _ref[2];
          ...
          if (error != null) {
            ...
            for (_i = 0, _len = result.length; _i < _len; _i++) {
              ...
              _results.push((function(raw) {
                var g, push, _ref1;
                g = Grade._convertRaw(_this._magisterObj, raw);
                g._columnUrl = _this._columnUrlPrefix + ((_ref1 = raw.CijferKolom) != null ? _ref1.Id : void 0);
                push = _helpers.asyncResultWaiter(2, function() {
                  return pushResult(g);
                });
      ...
      return this._magisterObj.http.get("" + this._magisterObj._personUrl + "/aanmeldingen/" + this._id + "/mentor", {}, (function(_this) {
        return function(error, result) {
          if (error != null) {
            ...
            return callback(null, Person._convertRaw(_this._magisterObj, EJSON.parse(result.content)));
          }
        };
      })(this));
    };
      ...
      return this._magisterObj.http.get("" + this._magisterObj._personUrl + "/aanmeldingen/" + this._id + "/mentor", {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            items = EJSON.parse(result.content).items;
            return callback(null, (function() {
              var _i, _len, _results;
              _results = [];
              for (_i = 0, _len = items.length; _i < _len; _i++) {
                p = items[_i];
                _results.push(Person._convertRaw(this._magisterObj, p));
              }
              return _results;
            }).call(_this));
          }
  ...
  this.Magister = (function() {
    ...
    Magister.prototype.studyGuides = function(callback) {
      var cb, fillClass, _ref;
      this._forceReady();
      fillClass = (_ref = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? _ref : true;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      ...
      cb = (function(_this) {
        return function(classes) {
          return _this.http.get("" + _this._pupilUrl + "/studiewijzers?peildatum=" + (_helpers.urlDateConvert(new Date)), {}, function(error, result) {
    ...
    Magister.prototype.assignments = function() {
      var amount, callback, cb, fillClass, fillPersons, skip, _ref, _ref1;
      this._forceReady();
      _ref = _.filter(arguments, function(a) {
        return _.isNumber(a);
      }), amount = _ref[0], skip = _ref[1];
      _ref1 = _.filter(arguments, function(a) {
        return _.isBoolean(a);
      }), fillPersons = _ref1[0], fillClass = _ref1[1];
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
      if (callback == null) {
            ...
            if (error != null) {
              ...
              for (_i = 0, _len = result.length; _i < _len; _i++) {
                ...
                _results.push(_this.http.get("" + _this._personUrl + "/opdrachten/" + id, {}, function(error, result) {
                  ...
                  if (fillPersons) {
                    teachers = (_ref2 = assignment.teachers()) != null ? _ref2 : [];
                    return _this.fillPersons(teachers, (function(e, r) {
    ...
    Magister.prototype.digitalSchoolUtilities = function() {
      var callback, cb, fillClass, url, _class, _ref;
      this._forceReady();
      fillClass = (_ref = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? _ref : true;
          ...
          return _this.http.get(url, {}, function(error, result) {
            ...
            if (error != null) {
              ...
              if (classes != null) {
                ...
                _fn1 = function(u) {
                  return u._class = Class._convertRaw(_this, u._class);
                };
  ...
  this.Message = (function() {
    ...
    Message.prototype.createReplyMessage = function(newContent) {
      ...
      msg = new Message(this._magisterObj);
  ...
  this.Person = (function() {
    ...
    Person._convertRaw = function(magisterObj, raw) {
      ...
      obj._description = (_ref = (_ref1 = raw.Omschrijving) != null ? _ref1 : raw.Naam) != null ? _ref : raw.naam;
  ...
  this.ProfileInfo = (function() {
    ...
    ProfileInfo.prototype.detailedInfo = function(callback) {
      ...
      push = _helpers.asyncResultWaiter(2, function(r) {
        return callback(null, DetailedProfileInfo._convertRaw(_.extend(r[0], r[1])));
      });
      this._magisterObj.http.get("" + this._magisterObj._personUrl + "/profiel", {}, function(e, r) {
        if (e != null) {
          return callback(e, null);
        } else {
          return push(EJSON.parse(r.content));
        }
      });
  ...
  this.DetailedProfileInfo = (function() {
    function DetailedProfileInfo() {
      ...
      /**
      		 ...
      		 * @type Boolean
       */
      this.redirectMagisterMessages = _getset("_redirectMagisterMessages");
      ...
      /**
      		 ...
      		 * @type String
       */
      this.mobileNumber = _getset("_mobileNumber");
      ...
      /**
      		 ...
      		 * @type String
       */
      this.postalCode = _getset("_postalCode");
      ...
      /**
      		 ...
      		 * @type Number
       */
      this.houseNumber = _getset("_houseNumber");
