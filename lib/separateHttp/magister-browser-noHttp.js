          ...
          if (error != null) {
            ...
            for (_i = 0, _len = result.length; _i < _len; _i++) {
              ...
              _results.push((function(g) {
                ...
                g.teacher._type = 3;
                return _this._magisterObj.http.get(_this._columnUrl + g.CijferKolom.Id, {}, function(error, result) {
                  g = Grade._convertRaw(_this._magisterObj, g, _this._gradesUrlPrefix);
                  if (error != null) {
                    return callback(error, null);
                  } else {
