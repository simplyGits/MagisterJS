/* Magister.js (browser version) by simplyApps. Built on: 16-04-2015 */
(function() {
  var EJSON, findQueries, messageFolder, root, _, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
        ...
        _results.push(this._magisterObj.http.get("" + this._magisterObj._personUrl + "/opdrachten/versie/" + id, {}, (function(_this) {
          return function(error, result) {
            if (error != null) {
              ...
              return pushResult(root.AssignmentVersion._convertRaw(_this._magisterObj, _this, EJSON.parse(result.content)));
            }
          };
        })(this)));
      }
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var _i, _len, _ref3, _results;
              _ref3 = EJSON.parse(result.content);
              _results = [];
              for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
                c = _ref3[_i];
      ...
      return this._magisterObj.http.get("" + this._magisterObj._personUrl + "/aanmeldingen/" + this._id + "/mentor", {}, (function(_this) {
        return function(error, result) {
          if (error != null) {
            ...
            return callback(null, root.Person._convertRaw(_this._magisterObj, EJSON.parse(result.content)));
          }
        };
      })(this));
    };
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            files = (function() {
              ...
              _ref5 = EJSON.parse(result.content).Items;
              _results = [];
  ...
  root.File = (function() {
    ...
    File.prototype.download = function() {
      var callback, downloadFile, request, _ref5;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
      ...
      }).pipe(downloadFile != null ? require("fs").createWriteStream(this.name()) : null);
    };
  ...
  if ((typeof EJSON === "undefined" || EJSON === null) && (typeof require !== "undefined" && require !== null)) {
    this.EJSON = EJSON = require("ejson");
  }
  ...
  root.Magister = (function() {
    ...
    Magister.prototype.appointments = function() {
      var callback, dateConvert, download, from, to, url, _ref7, _ref8;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
      download = (_ref7 = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? _ref7 : true;
      ...
      return this.http.get(url, {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            absences = [];
            hit = root._helpers.asyncResultWaiter(3, function(r) {
              var _fn, _i, _len;
              _fn = function(a) {
              ...
              _.remove(appointments, function(a) {
                return root._helpers.date(a.begin()) < root._helpers.date(from) || root._helpers.date(a.end()) > root._helpers.date(to);
              });
            ...
            _this.http.get("" + _this._personUrl + "/roosterwijzigingen?tot=" + (dateConvert(to)) + "&van=" + (dateConvert(from)), {}, function(error, result) {
              var appointment, c, _i, _len, _ref9;
              _ref9 = EJSON.parse(result.content).Items;
              for (_i = 0, _len = _ref9.length; _i < _len; _i++) {
                c = _ref9[_i];
                appointment = root.Appointment._convertRaw(_this, c);
                _.remove(appointments, function(a) {
        ...
        return this.http.get(url, {}, (function(_this) {
          return function(error, result) {
            ...
            if (error != null) {
              ...
              result = (function() {
                var _i, _len, _ref7, _results;
                _ref7 = EJSON.parse(result.content).Items;
                _results = [];
                for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
                  p = _ref7[_i];
          ...
          return _this.http.get("" + _this._pupilUrl + "/studiewijzers?peildatum=" + (root._helpers.urlDateConvert(new Date)), {}, function(error, result) {
            ...
            if (error != null) {
              ...
              result = (function() {
                ...
                _ref8 = EJSON.parse(result.content).Items;
                _results = [];
            ...
            if (error != null) {
              ...
              for (_i = 0, _len = result.length; _i < _len; _i++) {
                ...
                _results.push(_this.http.get("" + _this._personUrl + "/opdrachten/" + id, {}, function(error, result) {
                  ...
                  assignment = root.Assignment._convertRaw(_this, EJSON.parse(result.content));
                  if (classes != null) {
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            messages = (function() {
              ...
              _ref12 = EJSON.parse(result.content).Items;
              _results = [];
        ...
        return function(error, result) {
          ...
          if (error != null) {
            ...
            messageFolders = (function() {
              ...
              _ref10 = EJSON.parse(result.content).Items;
              _results = [];
              for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
                mF = _ref10[_i];
      ...
      return this._magisterObj.http.post("" + this._magisterObj._personUrl + "/berichten/mappen", folder, {}, (function(_this) {
        return function(error, result) {
          if (error != null) {
            ...
            return callback(null, root.MessageFolder._convertRaw(_this._magisterObj, EJSON.parse(result.content)));
          }
        };
      })(this));
    };
      ...
      return new MagisterHttp().get("https://mijn.magister.net/api/schools?filter=" + query, {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, (function() {
              var _i, _len, _ref12, _results;
              _ref12 = EJSON.parse(result.content);
              _results = [];
              for (_i = 0, _len = _ref12.length; _i < _len; _i++) {
                s = _ref12[_i];
          ...
          if (error != null) {
            ...
            for (_i = 0, _len = _ref13.length; _i < _len; _i++) {
              ...
              _results.push(_this._magisterObj.http.get("" + _this._magisterObj._pupilUrl + "/studiewijzers/" + (_this.id()) + "/onderdelen/" + id, {}, function(error, result) {
                return pushResult(root.StudyGuidePart._convertRaw(_this._magisterObj, EJSON.parse(result.content)));
              }));
            }
            return _results;
          }
