(function() {
  ...
  root.Course = (function() {
    ...
    Course._convertRaw = function(magisterObj, raw) {
      ...
      obj._current = (obj._begin.getTime() <= (_ref3 = _.now()) && _ref3 <= obj._end.getTime());
      return obj;
    };
  ...
  root.Grade = (function() {
    ...
    Grade._convertRaw = function(magisterObj, raw) {
      var obj, val, _ref10, _ref6, _ref7, _ref8, _ref9;
      ...
      obj._gradePeriod = {
        id: (_ref6 = raw.CijferPeriode) != null ? _ref6.Id : void 0,
        name: (_ref7 = (_ref8 = raw.CijferPeriode) != null ? _ref8.Naam : void 0) != null ? _ref7 : ""
      };
      obj._class = {
        id: raw.Vak.Id,
        abbreviation: (_ref9 = raw.Vak.Afkorting) != null ? _ref9 : "",
        description: (_ref10 = raw.Vak.Omschrijving) != null ? _ref10 : ""
      };
          ...
          if (error != null) {
            ...
            finish = root._helpers.asyncResultWaiter(3, function(r) {
              ...
              appointments = _(appointments).reject(function(a) {
                ...
                return root._helpers.date(a.begin()) <= to && root._helpers.date(a.end()) >= from;
              }).sortBy("_begin").value();
        ...
        if (error != null) {
          ...
          try {
            ...
            return callback(null, {
              ...
              type: {
                year: +((_ref7 = /\d+/.exec(parsed.Studie)) != null ? _ref7[0] : void 0),
                schoolVariant: (_ref8 = /[^\d\s]+/.exec(parsed.Studie)) != null ? _ref8[0] : void 0
              }
            });
          } catch (_error) {
            e = _error;
        ...
        return function(sessionId) {
          ...
          try {
            ...
            return _this.http.get("" + _this.magisterSchool.url + "/api/account", {}, function(error, result) {
              ...
              return _this._fetchMessageFolders(function(e, r) {
                if (e != null) {
        ...
        return this.http.post(url, {
          ...
          return function(error, result) {
            if (error != null) {
              ...
              return cb(/[a-z\d-]+/.exec(result.headers["set-cookie"][0])[0]);
            }
          };
        })(this));
      }
