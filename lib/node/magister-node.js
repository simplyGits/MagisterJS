(function() {
  var findQueries, messageFolder, request, root, wrapCallback, _, _base, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  root.Appointment = (function() {
    ...
    Appointment.prototype.remove = function(cb) {
      ...
      return this._magisterObj.http["delete"](this._url, {}, _.ary(cb, 1));
    };
  ...
  root.Course = (function() {
    ...
    Course.prototype.grades = function() {
      ...
      }), fillPersons = _ref3[0], fillGrade = _ref3[1];
  ...
  root.Grade = (function() {
        ...
        return this._magisterObj.http.get(this._columnUrl, {}, (function(_this) {
          return function(error, result) {
            ...
            if (error != null) {
              ...
              _this._testDate = new Date(Date.parse(result.WerkinformatieDatumIngevoerd));
    ...
    Grade._convertRaw = function(magisterObj, raw) {
      ...
      obj._gradePeriod = {
        ...
        name: (_ref6 = raw.CijferPeriode.Naam) != null ? _ref6 : ""
      };
      obj._class = {
        id: raw.Vak.Id,
  ...
  root.GradeType = (function() {
    function GradeType(_magisterObj) {
      ...
      this.isEnd = function() {
        var _ref6;
        return (_ref6 = this.type()) === 2 || _ref6 === 3 || _ref6 === 4 || _ref6 === 5 || _ref6 === 6 || _ref6 === 7 || _ref6 === 13 || _ref6 === 14;
      };
    }
  ...
  root.Magister = (function() {
    ...
    Magister.prototype.appointments = function() {
      var callback, dateConvert, dates, fillPersons, from, to, url, _ref7, _ref8;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      });
            ...
            finish = root._helpers.asyncResultWaiter(2, function(r) {
              _.each(appointments, function(a) {
                return a._absenceInfo = _.find(absenceInfo, function(i) {
                  return i.appointmentId === a.id();
                });
              });
              appointments = _(appointments).filter(function(a) {
                var begin, end;
                begin = root._helpers.date(a.begin());
                end = root._helpers.date(a.end());
                return a.end() > from && begin <= to && end >= from;
              }).sortBy('_begin').value();
    ...
    Magister.prototype.createAppointment = function(options, callback) {
      var content, key, payload, required, start, _i, _len, _ref7, _ref8, _ref9;
      this._forceReady();
    ...
    Magister.prototype.messageFolders = function(query, callback) {
      ...
      if (!_.isString(query)) {
        ...
        query = query.trim();
        result = _.filter(this._messageFolders, function(mF) {
    ...
    Magister.prototype._fetchMessageFolders = function(callback) {
      return this.http.get("" + this._personUrl + "/berichten/mappen", {}, (function(_this) {
        return function(e, r) {
          var m;
          if (e != null) {
            e.statusCode = typeof result !== "undefined" && result !== null ? result.statusCode : void 0;
            return callback(e);
          } else {
      ...
      return this.http.get(url, {}, (function(_this) {
        return function(error, result) {
          ...
          if (error != null) {
            ...
            return callback(null, _(converted).sortBy("_beginDate").sortBy(function(x) {
              return !x._current;
            }).value());
          }
        };
    ...
    Magister.prototype.getPersons = function() {
      var b1, b2, callback, e, query, queryType, type, url, val, _ref7;
      this._forceReady();
      _ref7 = _.filter(arguments, function(a) {
        return _.isNumber(a) || _.isString(a);
      ...
      if (type == null) {
        b1 = b2 = false;
        b1 = this.getPersons(query, 3, (function(_this) {
          return function(e, r) {
            var teachers;
            if (e != null) {
              return callback(e, null);
              ...
              teachers = r;
              return b2 = _this.getPersons(query, 4, function(e, r) {
                if (e != null) {
                  return callback(e, null);
                } else {
            ...
            if (error != null) {
              ...
              result = (function() {
                ...
                for (_i = 0, _len = _ref8.length; _i < _len; _i++) {
                  p = _ref8[_i];
                  _results.push(root.Person._convertRaw(this, p, type));
                }
                return _results;
              }).call(_this);
    ...
    Magister.prototype.composeAndSendMessage = function() {
      ...
      recipients = _.findLast(arguments, function(a) {
        return a !== callback;
      });
    ...
    Magister.prototype._reLogin = function(sessionId) {
      var cb, deleteUrl, setSessionId, url;
      this._ready = false;
      ...
      url = "" + this.magisterSchool.url + "/api/sessies";
  ...
  root.MessageFolder = (function() {
    ...
    MessageFolder.prototype.messages = function() {
      var callback, fillPersons, limit, queries, url, _ref10, _ref11, _ref9;
      ...
      fillPersons = (_ref11 = _.find(arguments, function(a) {
        return _.isBoolean(a);
      })) != null ? _ref11 : false;
      callback = _.find(arguments, function(a) {
        return _.isFunction(a);
      ...
      return this._magisterObj.http.get(url, {}, (function(_this) {
        return function(error, result) {
          var m, messages, pushMessage, _fn, _i, _len;
          if (error != null) {
            callback(error, null);
          } else {
            messages = (function() {
            ...
            _fn = function(m) {
              ...
              return _this._magisterObj.http.get(url, {}, function(error, result) {
                ...
                m._attachments = (function() {
                  var _j, _len1, _ref12, _ref13, _results;
    ...
    Person._convertType = function(original, setter) {
      ...
      if (setter) {
        if (_.isNumber(original)) {
          if (original !== 1 && original !== 3 && original !== 4 && original !== 8) {
  ...
  root.ProfileInfo = (function() {
    ...
    ProfileInfo.prototype.extraInfo = function(callback) {
      var url;
      ...
      return this._magisterObj.http.get(url, {}, function(e, r) {
        ...
        if (e != null) {
          ...
          parsed = JSON.parse(r.content);
          return callback(null, root.ExtraProfileInfo._convertRaw(this._magisterObj, parsed));
        }
      });
    };
  ...
  root.ExtraProfileInfo = (function() {
    function ExtraProfileInfo() {
    ...
    ExtraProfileInfo._convertRaw = function(magisterObj, raw) {
      var obj;
  ...
  root.StudyGuide = (function() {
    ...
    StudyGuide._convertRaw = function(magisterObj, raw) {
      ...
      if (_.isNaN(obj._from.getTime())) {
        obj._from = null;
      }
      obj._to = new Date(Date.parse(raw.TotEnMet));
      if (_.isNaN(obj._to.getTime())) {
        obj._to = null;
      }
