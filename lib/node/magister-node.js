(function() {
  ...
  root.Magister = (function() {
    ...
    Magister.prototype.appointments = function() {
      ...
      _ref8 = _.sortBy(dates, function(d) {
        return d.getDate();
          ...
          if (error != null) {
            ...
            finish = root._helpers.asyncResultWaiter(2, function(r) {
              ...
              appointments = _(appointments).filter(function(a) {
                return from <= root._helpers.date(a.begin()) && root._helpers.date(a.end()) <= to;
              }).sortBy('_begin').value();
    ...
    Magister.prototype._reLogin = function(sessionId) {
      ...
      if (sessionId != null) {
        ...
        return this.http["delete"](deleteUrl, {}, (function(_this) {
          return function(e, r) {
            _this.http._cookie = r.headers["set-cookie"][0];
