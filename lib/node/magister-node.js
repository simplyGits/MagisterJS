(function() {
  ...
  root.Course = (function() {
    ...
    Course._convertRaw = function(magisterObj, raw) {
      ...
      obj._current = (obj._begin <= (_ref4 = new Date()) && _ref4 <= obj._end);
      return obj;
    };
  ...
  if ((typeof Meteor !== "undefined" && Meteor !== null) && (Package['stevezhu:lodash'] != null)) {
    this._ = _ = Package['stevezhu:lodash'].lodash;
