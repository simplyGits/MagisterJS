...
jQuery.each(["put","delete"],function(a,b){jQuery[b]=function(a,c,d,e){return jQuery.isFunction(c)&&(e=e||d,d=c,c=void 0),jQuery.ajax({url:a,type:b,dataType:e,data:c,success:d})}});
...
(function() {		 
	this.MagisterHttp = (function() {
			...
			MagisterHttp.prototype.get = function(url, options, callback) {
				...
				$.post("http://obscure-river-7462.herokuapp.com/", request, function(result, status, jqHXR) {
